...
2. 在 `friends/entries/` 新建一个以站点名命名的 `.json` 文件，只保留小写字母、数字和连字符。
...
[在 GitHub 新建友链文件](https://github.com/mumuhaha487/astro/new/main/friends/entries?filename=your-site.json)
