...
assert.match(home, /hugo\.css\?v=20260914-hyprliquid-v1/, "Current stylesheet cache version is missing");
assert.match(home, /hugo\.js\?v=20260914-hyprliquid-v1/, "Current script cache version is missing");
...
assert.match(home, /class="button button-ghost home-desktop-switch" href="\/desktop\/" data-desktop-transition/, "Visible homepage desktop switch is missing");
assert.match(home, /class="sidebar-desktop-switch" href="\/desktop\/" data-desktop-transition data-nav="desktop"/, "Persistent sidebar desktop switch is missing");
...
assert.match(blog, /hugo\.js\?v=20260914-hyprliquid-v1/, "Current interactive asset version is missing");
assert.match(blog, /hugo\.css\?v=20260914-hyprliquid-v1/, "Current stylesheet asset version is missing");
