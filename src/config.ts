...
export const siteConfig: SiteConfig = {
	...
	navbarTitle: {
		...
		icon: "assets/home/favicon-light-32.webp",
		// 网站Logo图片路径
		logo: "assets/home/favicon-light-32.webp",
	},
	...
	bilibili: {
		vmid: "334584883", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Mumuemhaha Blog", // 主页横幅主标题

			subtitle: [
				"不知道啊，这不是领地狱火的网站吗？",
				"不知道啊，听说这里有鸡蛋领",
				"没有人类了",
				"~呜嗷嗷嗷嗷呜啊嗷啊~呜嗷呜呜~呜啊~啊嗷啊呜嗷呜~~~嗷~呜呜呜~~嗷嗷嗷呜啊呜呜啊呜嗷呜呜啊呜嗷呜啊嗷啊呜~嗷啊啊~嗷~呜嗷嗷~啊嗷嗷嗷呜啊呜啊呜呜嗷呜呜~嗷呜嗷啊嗷啊呜嗷呜~啊~嗷~呜呜呜嗷啊嗷嗷嗷呜呜嗷嗷呜呜嗷呜呜~嗷啊啊啊嗷啊呜嗷嗷啊呜啊",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/mumuhaha487",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/334584883",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/mumuemhaha",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/demo-avatar.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "木木em哈哈",
	bio: "不乱于心，不困于情，不畏将来，不惧过去",
	typewriter: {
	...
	links: [
		...
		},
		{
			name: "Discord",
			icon: "fa7-brands:qq",
			url: "https://qm.qq.com/q/CpxtMS5DsA",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "mumuhaha487/astro",
		repoId: "R_kgDOPjTkdA",
		category: "Announcements",
		categoryId: "DIC_kwDOPjTkdM4CuiIf",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const footerConfig: FooterConfig = {
	...
	customHtml: '<p><a href="https://beian.miit.gov.cn/" target="_blank">赣ICP备2024038464号-3</a></p>'
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://github.com/mumuhaha487", // 关于链接
	},
};
